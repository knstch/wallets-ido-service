...
// DBRepo is a Postgres-backed repository implementation using GORM.
type DBRepo struct {
	lg *log.Logger
	db *gorm.DB
}

// Repository defines database operations used by the wallets service.
...
// If db is nil, it clones the base repository DB session.
